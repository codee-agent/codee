...
function generateHandlersAndExports() {
	...
	for (const [name, def] of Object.entries(proto.codee)) {
		...
		handlerSetup.push(`    server.addService(codee.${name}Service, {`)
		for (const [rpcName, rpc] of Object.entries(def.service)) {
			imports.push(`import { ${rpcName} } from "@core/controller/${dir}/${rpcName}"`)
			const requestType = "codee." + rpc.requestType.type.name
			...
			if (rpc.responseStream) {
				...
				const responseType = "codee." + rpc.responseType.type.name
...
import * as grpc from "@grpc/grpc-js"
import { codee } from "@generated/grpc-js"
