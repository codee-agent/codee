...
<Info>
**Pro Tip:** Assign `Alt+T` to the `codee.addTerminalOutputToChat` command for quick terminal output capture. Without a shortcut, you can still right-click in the terminal and select "Add to Cline" - but the keyboard approach is much faster for frequent debugging workflows.
</Info>
...
| ---------- | ----------- | ------------------ |
| `codee.plusButtonClicked` | Start a new task | `Ctrl+Shift+N` / `Cmd+Shift+N` |
| `codee.historyButtonClicked` | Open task history | `Ctrl+Shift+H` / `Cmd+Shift+H` |
| `codee-me.SidebarProvider.focus` | Open Cline sidebar | `Ctrl+Shift+L` / `Cmd+Shift+L` |
...
| Command ID | Description | Suggested Shortcut |
| ---------- | ----------- | ------------------ |
| `codee.addToChat` | Add selected code to chat | `Ctrl+'` / `Cmd+'` ⭐ (default) |
| `codee.focusChatInput` | Focus chat input | `Ctrl+'` / `Cmd+'` ⭐ (default) |
| `codee.explainCode` | Explain selected code | `Ctrl+Shift+E` / `Cmd+Shift+E` |
| `codee.improveCode` | Suggest code improvements | `Ctrl+Shift+I` / `Cmd+Shift+I` |
...
| Command ID | Description | Suggested Shortcut |
| ---------- | ----------- | ------------------ |
| `codee.addTerminalOutputToChat` | Add terminal output to Cline | `Alt+T` |
...
| Command ID | Description | Suggested Shortcut |
| ---------- | ----------- | ------------------ |
| `codee.generateGitCommitMessage` | Generate commit message | `Ctrl+Shift+G` / `Cmd+Shift+G` |
| `codee.abortGitCommitMessage` | Stop generation | `Ctrl+Shift+Esc` / `Cmd+Shift+Esc` |
...
| Command ID | Description | Suggested Shortcut |
| ---------- | ----------- | ------------------ |
| `codee.settingsButtonClicked` | Open Cline settings | `Ctrl+Alt+,` / `Cmd+Opt+,` |
| `codee.mcpButtonClicked` | Open MCP servers config | `Ctrl+Alt+M` / `Cmd+Opt+M` |
| `codee.accountButtonClicked` | Open account settings | `Ctrl+Alt+A` / `Cmd+Opt+A` |
| `codee.openWalkthrough` | Open walkthrough guide | (not recommended) |
