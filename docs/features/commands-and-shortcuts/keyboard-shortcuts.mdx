...
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`codee.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`codee.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`codee.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `codee.focusChatInput`                                                                   | Focuses the Cline chat input field            |
| [`codee.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`codee.explainCode`](/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`codee.improveCode`](/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`cline.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
| `codee-me.SidebarProvider.focus`                                                         | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `codee-me.SidebarProvider.focus`          | Opens the Cline sidebar panel |
| New Task              | `Alt+N`                        | `codee.plusButtonClicked`                 | Starts a new Cline task       |
| Add Terminal to Cline | `Alt+T`                        | `codee.addTerminalOutputToChat`           | Adds terminal output to Cline |
