...
-   This file is located at: `/Users/<username>/Library/Application Support/Code/User/globalStorage/Codee.codee/settings/codee_mcp_settings.json`
...
1. Open the MCP settings file: `/Users/<username>/Library/Application Support/Code/User/globalStorage/Codee.codee/settings/codee_mcp_settings.json`
...
-   Try removing and reinstalling the server (remove from both the `codee_mcp_settings.json` file and the `/Users/<username>/Documents/Cline/MCP/` directory)
