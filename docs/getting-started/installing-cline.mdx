...
<Tabs>
  <Tab title="VS Code/Cursor" icon="code">
    ...
    <Steps>
      ...
      <Step title="Search for Cline">
        Type **"Codee"** in the Extensions marketplace search bar
        	<Frame>
    ...
    **Plugin Installation Issues**
    ...
    - Try searching for "Cline AI" or just "Codee"
      ...
      <Tab title="From IDE (Recommended)">
        <Steps>
          ...
          <Step title="Install Cline">
            Search for **"Codee"** and click **Install**
  ...
  <Tab title="VSCodium/Windsurf" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Search for Cline">
        Type **"Codee"** in the marketplace search bar
      </Step>

      <Step title="Install by Author">
        Select **"Codee" by saoudrizwan** and click **Install**
      </Step>
