import { CODEBASE_INDEX_DEFAULTS } from "@shared/codebase-index"
...
/**OpenAI Embedder */
export const MAX_BATCH_TOKENS = 10000
...
export const DEFAULT_CODEBASE_INDEX_CONFIG = {
  ...
  codebaseIndexEmbedderBaseUrl: `${VALUE_CODEE_BASE_URL}v1/embeddings`,
  codebaseIndexEmbedderModelId: "BAAI/bge-m3",
  codebaseIndexSearchMinScore: DEFAULT_SEARCH_MIN_SCORE,
  codebaseIndexSearchMaxResults: DEFAULT_MAX_SEARCH_RESULTS,
}

export const QDRANT_DOWNLOAD_BASE_URL = "https://github.com/qdrant/qdrant/releases/download/v1.15.4/"