...
export class WebviewProvider implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "codee-me.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "codee-me.TabPanelProvider"
		...
		// this.clearTask()
		{
			...
			vscode.workspace.onDidChangeConfiguration(
				async (e) => {
					...
					if (e && e.affectsConfiguration("codee.mcpMarketplace.enabled")) {
