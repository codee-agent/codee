...
export async function readStateFromDisk(context: ExtensionContext) {
	...
	const [
		...
		context.secrets.get("codeeId") as Promise<string | undefined>,
		...
		context.secrets.get("codeeToken") as Promise<string | undefined>,
		context.secrets.get("codeeUserName") as Promise<string | undefined>,
		context.secrets.get("codeeApiKey") as Promise<string | undefined>,

	])

	const codeeModelId = context.globalState.get("codeeModelId") as string | undefined
