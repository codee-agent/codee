...
export async function ensureMcpServersDirectoryExists(): Promise<string> {
	...
	try {
		...
		return "~/Documents/Codee/MCP" // in case creating a directory in documents fails for whatever reason (e.g. permissions) - this is fine since this path is only ever used in the system prompt
	}
