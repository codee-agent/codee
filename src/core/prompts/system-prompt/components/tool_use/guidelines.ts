...
const CODEBASE_TOOL_USE_GUIDELINES_TEMPLATE_TEXT = `# Tool Use Guidelines
...
export async function getToolUseGuidelinesSection(_variant: PromptVariant, context: SystemPromptContext): Promise<string> {
	...
	return new TemplateEngine().resolve(context.isCodebaseSearchAvailable ? CODEBASE_TOOL_USE_GUIDELINES_TEMPLATE_TEXT : TOOL_USE_GUIDELINES_TEMPLATE_TEXT, context, {})
}
