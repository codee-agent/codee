...
import { codebaseIndexConfigInfo } from "@shared/codebase-index"
...
const GLOBAL_STATE_FIELDS = {
	...
	codebaseIndexConfig: {default: {} as codebaseIndexConfigInfo}
} satisfies FieldDefinitions
...
const API_HANDLER_SETTINGS_FIELDS = {
	...
	codeeModelId: { default: undefined as string | undefined },
	// codeeApiKey: { default: undefined as string | undefined },
	...
	ollamaModelId: {default: undefined as string | undefined}
} satisfies FieldDefinitions
