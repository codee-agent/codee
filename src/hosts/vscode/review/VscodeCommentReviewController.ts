...
export class VscodeCommentReviewController extends CommentReviewController implements vscode.Disposable {
	...
	constructor() {
		...
		this.commentController = vscode.comments.createCommentController("codee-ai-review", "Codee AI Review")
		...
		this.disposables.push(
			vscode.commands.registerCommand("codee.reviewComment.reply", async (reply: vscode.CommentReply) => {
		...
		this.disposables.push(
			vscode.commands.registerCommand("codee.reviewComment.addToChat", async (thread: vscode.CommentThread) => {
