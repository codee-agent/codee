...
export function isCodeeFamily(id: string): boolean {//huqb
	const modelId = id.toLowerCase()
	return modelId.includes("kimi-k2.5") || modelId.includes("glm-4.7") || modelId.includes("glm-5") // || modelId.includes("deepseek-v3.1")
}
