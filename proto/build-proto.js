...
const serviceNameMap = {
	account: "codee.AccountService",
	browser: "codee.BrowserService",
	checkpoints: "codee.CheckpointsService",
	file: "codee.FileService",
	mcp: "codee.McpService",
	state: "codee.StateService",
	task: "codee.TaskService",
	web: "codee.WebService",
	models: "codee.ModelsService",
	slash: "codee.SlashService",
	ui: "codee.UiService",
...
async function ensureProtoFilesExist() {
	...
	for (const [serviceName, fullServiceName] of Object.entries(serviceNameMap)) {
		if (!existingProtoServices.includes(serviceName)) {
			...
			// Extract service class name from full name (e.g., "codee.ModelsService" -> "ModelsService")
