		...
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					...
					Available in the Codee provider for free.
				</li>
				<li>
					<b>Focus Chain:</b> Keeps Codee focused on long-horizon tasks with automatic todo list management, breaking
				...
				<li>
					...
					context window limit. This significantly helps Codee stay on track for long task sessions!
				</li>
				<li>
					<b>Deep Planning:</b> New <code>/deep-planning</code> slash command transforms Codee into an architect who
			...
			<Accordion className="pl-0" isCompact>
				<AccordionItem
					...
					<ul style={ulStyle}>
						...
						<li>
							<b>Optimized for Claude 4:</b> Codee is now optimized to work with the Claude 4 family of models,
