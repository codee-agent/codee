			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						...
						<li>
							<b>UX Improvements:</b> Type while Codee works, smarter auto-scrolling, and copy buttons for task
						...
						<li>
							<b>Global Codee Rules:</b> Store multiple rules files in Documents/Cline/Rules to share between
							projects.
						</li>
					</ul>
				</AccordionItem>
