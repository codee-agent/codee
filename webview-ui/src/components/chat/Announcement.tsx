...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					<b>Optimized for Claude 4:</b> codee is now optimized to work with the Claude 4 family of models, resulting in
				...
				<li>
					<b>WebFetch Tool:</b> Gemini 2.5 Pro and Claude 4 models now support the WebFetch tool, allowing codee to
					retrieve and summarize web content directly in conversations.
				</li>
				<li>
					<b>Self Knowledge:</b> When using frontier models, codee is self-aware about his capabilities and featureset.
				</li>
				<li>
