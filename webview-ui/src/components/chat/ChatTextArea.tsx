			...
			<div>
				...
				<ControlsContainer>
					...
					<Tooltip
						...
						tipText={`In ${shownTooltipMode === "act" ? t("chat.actModeTooltip") : t("chat.planModeTooltip")}  mode, codee will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
