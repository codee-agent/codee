...
export function normalizeApiConfiguration(
	...
	switch (provider) {
		...
		case "codee":
			...
			const codeeModeInfo = apiConfiguration?.planModeOpenAiModelInfo
			return {
				selectedProvider: provider,
				selectedModelId: codeeModelId || "",
				selectedModelInfo: codeeModeInfo || openAiModelInfoSaneDefaults,
			}
		case "openai":
			const openAiModelId =
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	return {
		...
		codeeModelId: apiConfiguration.codeeModelId,
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		case "codee":
			updates.codeeModelId = sourceFields.codeeModelId
			break
		case "openrouter":
