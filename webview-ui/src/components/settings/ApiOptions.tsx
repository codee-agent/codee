...
import { CodeeProvider } from "./providers/CodeeProvider"
...
const ApiOptions = ({
	...
	const handleProviderChange = (newProvider: string) => {
		console.log("handleProviderChange newProvider", newProvider)
	...
	*/
	...
	return (
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			...
			{apiConfiguration && selectedProvider === "codee" && (
				<CodeeProvider currentMode={currentMode} />
			)}
