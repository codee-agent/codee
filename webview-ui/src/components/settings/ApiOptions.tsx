...
const ApiOptions = ({
	...
	const handleInputChange = (field: keyof ApiConfiguration) => (event: any) => {
		...
		console.log("config:" + apiConfiguration)
	}
			...
			{selectedProvider === "anthropic" && (
				<div>
					<VSCodeTextField
						...
						placeholder={t("settings.api.apiKey")}>
						<span style={{ fontWeight: 500 }}>{t("settings.api.apiKey")}</span>
					</VSCodeTextField>
					...
					{modelConfigurationSelected && (
						<>
							...
							<VSCodeCheckbox
								...
								{t("settings.api.supportsComputerUse")}
							</VSCodeCheckbox>
							<VSCodeCheckbox
							...
							<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
								<VSCodeTextField
									...
									<span style={{ fontWeight: 500 }}>{t("settings.api.inputPrice")}</span>
								</VSCodeTextField>
								<VSCodeTextField
									value={
									...
									<span style={{ fontWeight: 500 }}>{t("settings.api.outputPrice")}</span>
								</VSCodeTextField>
							</div>
							<div style={{ display: "flex", gap: 10, marginTop: "5px" }}>
								<VSCodeTextField
...
export function getOpenRouterAuthUrl(uriScheme?: string) {
	return `https://openrouter.ai/auth?callback_url=${uriScheme || "vscode"}://Codee.codee/openrouter`
}
