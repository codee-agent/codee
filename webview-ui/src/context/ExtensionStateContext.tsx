...
export interface ExtensionStateContextType extends ExtensionState {
	...
	openAiModels: string[]
	codeeModels: string[]
	setCodeeModels: (models: string[]) => void
	codeeCompleteModels: string[]
	setCodeeCompleteModels: (completeModels: string[]) => void
...
export const ExtensionStateContextProvider: React.FC<{
	...
	const [codeeModels, setCodeeModels] = useState<string[]>([])
	const [codeeCompleteModels, setCodeeCompleteModels] = useState<string[]>([])
			...
			onResponse: (response) => {
				if (response.stateJson) {
					try {
						...
						// console.log('stateData111', stateData)
						setState((prevState) => {
